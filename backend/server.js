...
app.get("/api/receipt/:ref/pdf", async (req, res) => {
  try {
    ...
    // Header Section
    doc.fontSize(24).font('Helvetica-Bold').text("RIA Federal Credit Union", { align: "left" });
    ...
    doc.fontSize(8).font('Helvetica').text(
      "This document is electronically generated by RIA Federal Credit Union's core banking system. No physical signature is required. If you did not authorize this transaction, contact customer support immediately.",
      { align: "center" }
    );
