...
app.get("/api/receipt/:ref/pdf", async (req, res) => {
  try {
    ...
    // Header Section
    doc.fontSize(24).font('Helvetica-Bold').text("Evergreen financial Bank", { align: "left" });
    ...
    doc.fontSize(8).font('Helvetica').text(
      "This document is electronically generated by Evergreen financial Bank's core banking system. No physical signature is required. If you did not authorize this transaction, contact customer support immediately.",
      { align: "center" }
    );
